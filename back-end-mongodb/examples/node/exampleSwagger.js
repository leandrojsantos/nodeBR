/**
 * swagger = front para rotas e documcutacao e gerado automaticamentica deste que tenha mapRoutes() e instalado vision, inert, hapi-swagger
 * 
 * npm install vision
 * npm install inert 
 ...
 * 
 * primeiro na api adiciona o app.register()
 */
...
/**
 * comeca por usar app.register() para importar modulos e se fazer tambem eles se comunicar  
 */
    await app.register([
        Inert,
        Vision,
    ...
    list() {
        return {
            ...
            config: {
                 ...
                 * ao adicionar a:
                 *  tags: ['nome do aquivo'],
                 * description: 'descricao sobre a funcao'
