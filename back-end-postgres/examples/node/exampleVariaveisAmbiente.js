/**
 * objtivo separa o projeto em dois ambientes desevolvimento e producao
 * 
...
/**
 * primeiro cria na raiz do proeto uma pasta config nela criar dois arquivos:
.env.dev
.env.prod

esses aquivos serao selecionados conforme o ambiente
*/

//apos pega todas a variaveis sensiveis do codigo por exemplo conexao dos bancos, porta da api e salt/key  para criptografia

//apos encontra substuir por nome da varivel no aquivo .env.dev ou .env.prod:
process.env.NOME_DA_VARIAVEL
//obs nome sempre em maiscuslo por exemplo:
...
//sao colocada primeiro para se algum precisar das variaveis 
const env = process.env.NODE_ENV || "dev"
ok(env === "prod" || env === "dev", "environment inválida! Ou prod ou dev")
//aqui configPath escolhe o .env idepende do lugar que rodar  
